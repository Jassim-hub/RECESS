@extends('layouts.app', ['activePage' => 'register', 'title' => 'The Mathematic Challenge'])
                                            ...
                                            <div class="form-group d-flex justify-content-center">
                                                <div class="form-check rounded col-md-10 text-left">
                                                    <label class="form-check-label text-white d-flex align-items-center">
                                                        ...
                                                        <b>{{ __('Agree to submit') }}</b>
                                                    </label>
                                                </div>
                                            </div>

                                            <div class="footer text-center">
                                                <button type="submit" class="btn btn-fill btn-neutral btn-wd">{{ __('Admin Register') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
